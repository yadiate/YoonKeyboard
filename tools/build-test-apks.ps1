...
$currentApk = Join-Path $dist "YoonKeyboard-current-com.yadiate.yoonkeyboard-v0.2.36.apk"
$legacyReleaseApk = Join-Path $dist "YoonKeyboard-legacy-com.example.eightwayime-v0.2.36-legacyfix-release.apk"
$legacyDebugApk = Join-Path $dist "YoonKeyboard-legacy-com.example.eightwayime-v0.2.36-legacyfix-debug.apk"
...
$legacyProps = @(
    ...
    "-PkeyboardVersionName=0.2.36-legacyfix",
