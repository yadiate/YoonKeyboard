...
$currentApk = Join-Path $dist "YoonKeyboard-current-com.yadiate.yoonkeyboard-v0.2.40.apk"
$legacyReleaseApk = Join-Path $dist "YoonKeyboard-legacy-com.example.eightwayime-v0.2.40-legacyfix-release.apk"
$legacyDebugApk = Join-Path $dist "YoonKeyboard-legacy-com.example.eightwayime-v0.2.40-legacyfix-debug.apk"
...
$legacyProps = @(
    ...
    "-PkeyboardVersionName=0.2.40-legacyfix",
